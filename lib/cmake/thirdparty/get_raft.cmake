...
function(find_and_configure_raft)
    ...
    if(PKG_CLONE_ON_PIN AND NOT PKG_PINNED_TAG STREQUAL "branch-${RAFT_VERSION}")
        message(STATUS "FFANNS: RAFT pinned tag found: ${PKG_PINNED_TAG}. Cloning raft locally.")
        set(CPM_DOWNLOAD_raft ON)
    elseif(PKG_USE_RAFT_STATIC AND (NOT CPM_raft_SOURCE))
        message(STATUS "FFANNS: Cloning raft locally to build static libraries.")
        set(CPM_DOWNLOAD_raft ON)
    endif()
...
find_and_configure_raft(VERSION  ${RAFT_VERSION}.00
        ...
        ENABLE_NVTX              OFF
        USE_RAFT_STATIC ${FFANNS_USE_RAFT_STATIC}
        # When PINNED_TAG above doesn't match the default rapids branch,
        # force local raft clone in build directory
        # even if it's already installed.
        CLONE_ON_PIN     ${FFANNS_RAFT_CLONE_ON_PIN}
