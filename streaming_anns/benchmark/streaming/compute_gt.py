...
# rm /data2/pyc/data/msturing30M/30000000/test.yaml/*
# python benchmark/streaming/compute_gt.py --dataset msturing-30M --runbook_file runbooks/test.yaml --gt_cmdline_tool /data2/pyc/workspace/DiskANN/build/apps/utils/compute_groundtruth  